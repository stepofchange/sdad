...
public class TestActivity extends AppCompatActivity  implements CameraBridgeViewBase.CvCameraViewListener2, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TestButton = (Button)findViewById(R.id.testrecognize);
        ...
        if (mNativeDetector != null){
            ...
            if(predictedLabel>-1){
            	...
            	for (int i = 0; i < facesArray.length; i++){
            		...
            		Imgproc.putText(mRgba, "��� ��!", r.tl(), 3, 3, new Scalar(255, 0, 0, 255), 2);
            		Log.i("fsdhfsjdhfklsdf", "Good " + String.valueOf(predictedLabel));
                }
            }else{
            	Rect[] facesArray = faces.toArray();
            	for (int i = 0; i < facesArray.length; i++){
